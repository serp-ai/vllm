...
_MODELS = {
    ...
    "SparsetralForCausalLM": ("sparsetral", "SparsetralForCausalLM"),
    "modeling_sparsetral.MistralForCausalLM": ("sparsetral", "SparsetralForCausalLM"),
...
_ROCM_PARTIALLY_SUPPORTED_MODELS = {
    ...
    "SparsetralForCausalLM": "Sliding window attention is not yet supported in ROCm's flash attention",
}
